...
try:
    from igad_geonode.local_settings import *
...
#
PROJECT_NAME = 'igad_geonode'

SITENAME = 'igad_geonode'
...
ALLOWED_HOSTS = ['localhost', 'django', '51.255.134.48', 'igad-dev.geo-solutions.it'] if os.getenv('ALLOWED_HOSTS') is None \
